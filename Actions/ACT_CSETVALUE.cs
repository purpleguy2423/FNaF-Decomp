...
// Type: RuntimeXNA.Actions.ACT_CSETVALUE
...
namespace RuntimeXNA.Actions
{
    ...
    public class ACT_CSETVALUE : CAct
    {
      public override void execute(CRun rhPtr)
      {
        ...
        CCounter ccounter = (CCounter) actionObjects;
        ccounter.cpt_ToFloat(eventExpressionAny);
        ccounter.cpt_Change(eventExpressionAny);
      }
    }
}
