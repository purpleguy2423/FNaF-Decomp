...
// Type: RuntimeXNA.Actions.ACT_SETFRAMEHEIGHT
...
namespace RuntimeXNA.Actions
{
    ...
    public class ACT_SETFRAMEHEIGHT : CAct
    {
      public override void execute(CRun rhPtr)
      {
        ...
        rhPtr.rhFrame.leHeight = eventExpressionInt;
        if (leHeight == rhPtr.rhFrame.leVirtualRect.bottom)
          rhPtr.rhFrame.leVirtualRect.bottom = rhPtr.rhLevelSy = eventExpressionInt;
