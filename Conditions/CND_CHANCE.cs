...
// Type: RuntimeXNA.Conditions.CND_CHANCE
...
namespace RuntimeXNA.Conditions
{
    ...
    public class CND_CHANCE : CCnd
    {
      ...
      public override bool eva2(CRun rhPtr)
      {
        ...
        return eventExpressionInt2 >= 1 && eventExpressionInt1 > 0 && eventExpressionInt1 <= eventExpressionInt2 && (int) rhPtr.random((short) eventExpressionInt2) <= eventExpressionInt1;
      }
    }
}
