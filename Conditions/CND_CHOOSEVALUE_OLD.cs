...
// Type: RuntimeXNA.Conditions.CND_CHOOSEVALUE_OLD
...
namespace RuntimeXNA.Conditions
{
    ...
    public class CND_CHOOSEVALUE_OLD : CCnd
    {
      ...
      {
        int num = 0;
        for (CObject cobject = rhPtr.rhEvtProg.evt_FirstObjectFromType((short) 2); cobject != null; cobject = rhPtr.rhEvtProg.evt_NextObjectFromType())
        {
          ++num;
