...
// Type: RuntimeXNA.Conditions.CND_EXTCMPVARFIXED
...
namespace RuntimeXNA.Conditions
{
    ...
    public class CND_EXTCMPVARFIXED : CCnd, IEvaExpObject
    {
      ...
      {
        return CRun.compareTer((int) hoPtr.hoCreationId << 16 /*0x10*/ | (int) hoPtr.hoNumber & (int) ushort.MaxValue, value_Renamed, comp);
      }
    }
}
